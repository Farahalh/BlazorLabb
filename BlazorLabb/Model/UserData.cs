...
/// <summary>
/// The UserData class provides asynchronous retrieval of user data from a JSON file.
...
namespace BlazorLabb.Model
{
    public class UserData
    {
        ...
        public UserData(string filePath = "UserData.json")
        {
            _filePath = filePath;
        }
        ...
        public async Task<List<User>> GetUsersAsync()
        {
            ...
            return string.IsNullOrWhiteSpace(jsonData) ? new List<User>() : JsonSerializer.Deserialize<List<User>>(jsonData) ?? new List<User>();
        }
    }
}
